...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public MyStringBuilder2 delete(int start, int end)
	{
		...
		// ?? what if start is 0 and length > end ?????
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	private void builderSubstringBeginning(int counter, int subLength, char[] cArray, CNode currNode){
		...
		if(counter < subLength){
			// System.out.println("cArray[counter]: " + cArray[counter] + ", currNode: " + currNode);
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public CNode getLastC(){
		return this.lastC;
	}

	public char getLastCData(){
		return this.lastC.data;
	}
